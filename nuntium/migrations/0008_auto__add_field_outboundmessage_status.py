...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OutboundMessage.status'
        db.add_column(u'nuntium_outboundmessage', 'status',
                      self.gf('django.db.models.fields.CharField')(default='new', max_length='4'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OutboundMessage.status'
        db.delete_column(u'nuntium_outboundmessage', 'status')
    ...
    models = {
        ...
        u'nuntium.messagerecord': {
            ...
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
