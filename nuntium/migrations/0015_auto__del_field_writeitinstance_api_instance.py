...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WriteItInstance.api_instance'
        db.delete_column(u'nuntium_writeitinstance', 'api_instance_id')


    def backwards(self, orm):
        # Adding field 'WriteItInstance.api_instance'
        db.add_column(u'nuntium_writeitinstance', 'api_instance',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['popit.ApiInstance']),
                      keep_default=False)
