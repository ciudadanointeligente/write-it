...
class Migration(DataMigration):
    def forwards(self, orm):
        for instance in orm.WriteItInstance.objects.all():
            ...
            try:
                new_answer_notification_template.template_text = literal_eval(new_answer_notification_template.template_text)
            except (ValueError, SyntaxError):
                pass

            try:
                new_answer_notification_template.subject_template = literal_eval(new_answer_notification_template.subject_template)
            except (ValueError, SyntaxError):
                pass
            ...
            try:
                confirmation_template.content_text = literal_eval(confirmation_template.content_text)
            except (ValueError, SyntaxError):
                pass

            try:
                confirmation_template.subject = literal_eval(confirmation_template.subject)
            except (ValueError, SyntaxError):
                pass
    ...
    def backwards(self, orm):
        """I can see no reason why anyone would want to reverse this."""
    ...
    models = {
        ...
        u'nuntium.confirmation': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
