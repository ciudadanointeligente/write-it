...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WriteitInstancePopitInstanceRecord.created'
        db.alter_column(u'nuntium_writeitinstancepopitinstancerecord', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'WriteitInstancePopitInstanceRecord.created'
        db.alter_column(u'nuntium_writeitinstancepopitinstancerecord', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
