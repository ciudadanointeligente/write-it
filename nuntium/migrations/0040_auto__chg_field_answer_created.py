...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Answer.created'
        db.alter_column(u'nuntium_answer', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):

        # Changing field 'Answer.created'
        db.alter_column(u'nuntium_answer', 'created', self.gf('django.db.models.fields.DateField')())
