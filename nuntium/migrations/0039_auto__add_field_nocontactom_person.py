...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'nuntium_nocontactom', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='olinwi', to=orm['popit.Person']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NoContactOM.person'
        db.delete_column(u'nuntium_nocontactom', 'person_id')
