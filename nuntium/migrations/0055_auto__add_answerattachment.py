...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnswerAttachment'
        db.create_table(u'nuntium_answerattachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('answer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', to=orm['nuntium.Answer'])),
            ('content', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'nuntium', ['AnswerAttachment'])


    def backwards(self, orm):
        # Deleting model 'AnswerAttachment'
        db.delete_table(u'nuntium_answerattachment')
