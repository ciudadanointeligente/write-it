...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WriteItInstanceConfig.custom_from_domain'
        db.add_column(u'nuntium_writeitinstanceconfig', 'custom_from_domain',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.email_host'
        db.add_column(u'nuntium_writeitinstanceconfig', 'email_host',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.email_host_password'
        db.add_column(u'nuntium_writeitinstanceconfig', 'email_host_password',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.email_host_user'
        db.add_column(u'nuntium_writeitinstanceconfig', 'email_host_user',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.email_port'
        db.add_column(u'nuntium_writeitinstanceconfig', 'email_port',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.email_use_tls'
        db.add_column(u'nuntium_writeitinstanceconfig', 'email_use_tls',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.email_use_ssl'
        db.add_column(u'nuntium_writeitinstanceconfig', 'email_use_ssl',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WriteItInstanceConfig.custom_from_domain'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'custom_from_domain')

        # Deleting field 'WriteItInstanceConfig.email_host'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'email_host')

        # Deleting field 'WriteItInstanceConfig.email_host_password'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'email_host_password')

        # Deleting field 'WriteItInstanceConfig.email_host_user'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'email_host_user')

        # Deleting field 'WriteItInstanceConfig.email_port'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'email_port')

        # Deleting field 'WriteItInstanceConfig.email_use_tls'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'email_use_tls')

        # Deleting field 'WriteItInstanceConfig.email_use_ssl'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'email_use_ssl')
    ...
    models = {
        ...
        u'nuntium.confirmation': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.writeitinstanceconfig': {
            ...
            'custom_from_domain': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'email_host': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'email_host_password': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'email_host_user': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'email_port': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'email_use_ssl': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'email_use_tls': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
