...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WriteitInstancePopitInstanceRecord.autosync'
        db.delete_column(u'nuntium_writeitinstancepopitinstancerecord', 'autosync')

        # Adding field 'WriteitInstancePopitInstanceRecord.periodicity'
        db.add_column(u'nuntium_writeitinstancepopitinstancerecord', 'periodicity',
                      self.gf('django.db.models.fields.CharField')(default='1W', max_length='2'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WriteitInstancePopitInstanceRecord.autosync'
        db.add_column(u'nuntium_writeitinstancepopitinstancerecord', 'autosync',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'WriteitInstancePopitInstanceRecord.periodicity'
        db.delete_column(u'nuntium_writeitinstancepopitinstancerecord', 'periodicity')
    ...
    models = {
        ...
        u'nuntium.confirmation': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 31, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 31, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.writeitinstancepopitinstancerecord': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'periodicity': ('django.db.models.fields.CharField', [], {'default': "'1W'", 'max_length': "'1'"}),
