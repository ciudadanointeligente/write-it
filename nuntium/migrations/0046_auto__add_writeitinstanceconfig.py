...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WriteItInstanceConfig'
        db.create_table(u'nuntium_writeitinstanceconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('writeitinstance', self.gf('annoying.fields.AutoOneToOneField')(related_name='config', unique=True, to=orm['nuntium.WriteItInstance'])),
            ('testing_mode', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'nuntium', ['WriteItInstanceConfig'])


    def backwards(self, orm):
        # Deleting model 'WriteItInstanceConfig'
        db.delete_table(u'nuntium_writeitinstanceconfig')
