...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AboutPopitApiInstance'
        db.create_table(u'nuntium_aboutpopitapiinstance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('popit_api_instance', self.gf('django.db.models.fields.related.OneToOneField')(related_name='about', unique=True, to=orm['popit.ApiInstance'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'nuntium', ['AboutPopitApiInstance'])


    def backwards(self, orm):
        # Deleting model 'AboutPopitApiInstance'
        db.delete_table(u'nuntium_aboutpopitapiinstance')
    ...
    models = {
        ...
        u'nuntium.aboutpopitapiinstance': {
            'Meta': {'object_name': 'AboutPopitApiInstance'},
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'popit_api_instance': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'about'", 'unique': 'True', 'to': u"orm['popit.ApiInstance']"})
        },
        u'nuntium.answer': {
