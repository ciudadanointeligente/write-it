...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'nuntium_message', 'author_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Message.author_email'
        db.add_column(u'nuntium_message', 'author_email',
                      self.gf('django.db.models.fields.EmailField')(default='test@votainteligente.cl', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.author_name'
        db.delete_column(u'nuntium_message', 'author_name')

        # Deleting field 'Message.author_email'
        db.delete_column(u'nuntium_message', 'author_email')
    ...
    models = {
        ...
        u'nuntium.confirmation': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'wW6QGZkgunT8v5meFzGmTC7MuQ85Vbx7'", 'unique': 'True', 'max_length': '64'}),
