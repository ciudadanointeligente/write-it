...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'nuntium_message', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.updated'
        db.add_column(u'nuntium_message', 'updated',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'nuntium_message', 'created')

        # Deleting field 'Message.updated'
        db.delete_column(u'nuntium_message', 'updated')
    ...
    models = {
        ...
        u'nuntium.answer': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
