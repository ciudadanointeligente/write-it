...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'nuntium_message', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255))
        # Adding index on 'Message', fields ['slug']
        db.create_index(u'nuntium_message', ['slug'])


    def backwards(self, orm):
        # Removing index on 'Message', fields ['slug']
        db.delete_index(u'nuntium_message', ['slug'])


        # Changing field 'Message.slug'
        db.alter_column(u'nuntium_message', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
    ...
    models = {
        ...
        u'nuntium.answer': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
