...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswerAttachment.name'
        db.add_column(u'nuntium_answerattachment', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnswerAttachment.name'
        db.delete_column(u'nuntium_answerattachment', 'name')
    ...
    models = {
        ...
        u'nuntium.confirmation': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
