...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'nuntium_message', 'slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Message.subject'
        db.alter_column(u'nuntium_message', 'subject', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Message.slug'
        db.alter_column(u'nuntium_message', 'slug', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))

        # Changing field 'Message.subject'
        db.alter_column(u'nuntium_message', 'subject', self.gf('django.db.models.fields.CharField')(max_length=512))
    ...
    models = {
        ...
        u'nuntium.answer': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
