...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WriteItInstanceConfig.moderation_needed_in_all_messages'
        db.add_column(u'nuntium_writeitinstanceconfig', 'moderation_needed_in_all_messages',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.allow_messages_using_form'
        db.add_column(u'nuntium_writeitinstanceconfig', 'allow_messages_using_form',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.rate_limiter'
        db.add_column(u'nuntium_writeitinstanceconfig', 'rate_limiter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.notify_owner_when_new_answer'
        db.add_column(u'nuntium_writeitinstanceconfig', 'notify_owner_when_new_answer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WriteItInstanceConfig.autoconfirm_api_messages'
        db.add_column(u'nuntium_writeitinstanceconfig', 'autoconfirm_api_messages',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WriteItInstanceConfig.moderation_needed_in_all_messages'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'moderation_needed_in_all_messages')

        # Deleting field 'WriteItInstanceConfig.allow_messages_using_form'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'allow_messages_using_form')

        # Deleting field 'WriteItInstanceConfig.rate_limiter'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'rate_limiter')

        # Deleting field 'WriteItInstanceConfig.notify_owner_when_new_answer'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'notify_owner_when_new_answer')

        # Deleting field 'WriteItInstanceConfig.autoconfirm_api_messages'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'autoconfirm_api_messages')
    ...
    models = {
        ...
        u'nuntium.confirmation': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
