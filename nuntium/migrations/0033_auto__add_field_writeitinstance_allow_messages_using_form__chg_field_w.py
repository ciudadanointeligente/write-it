...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WriteItInstance.slug'
        db.alter_column(u'nuntium_writeitinstance', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from='name', unique_with=()))
        # Adding index on 'WriteItInstance', fields ['slug']
        db.create_index(u'nuntium_writeitinstance', ['slug'])

        # Adding unique constraint on 'WriteItInstance', fields ['slug']
        db.create_unique(u'nuntium_writeitinstance', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'WriteItInstance', fields ['slug']
        db.delete_unique(u'nuntium_writeitinstance', ['slug'])

        # Removing index on 'WriteItInstance', fields ['slug']
        db.delete_index(u'nuntium_writeitinstance', ['slug'])
        ...
        # Changing field 'WriteItInstance.slug'
        db.alter_column(u'nuntium_writeitinstance', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'nuntium.answer': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
