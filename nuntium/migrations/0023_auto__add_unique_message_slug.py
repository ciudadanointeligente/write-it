...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Message', fields ['slug']
        db.create_unique(u'nuntium_message', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Message', fields ['slug']
        db.delete_unique(u'nuntium_message', ['slug'])
