...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Message.slug'
        db.delete_column(u'nuntium_message', 'slug')
    ...
    models = {
        ...
        u'nuntium.answer': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
