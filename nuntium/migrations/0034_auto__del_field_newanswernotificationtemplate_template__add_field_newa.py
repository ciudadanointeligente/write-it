...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewAnswerNotificationTemplate.template'
        db.delete_column(u'nuntium_newanswernotificationtemplate', 'template')

        # Adding field 'NewAnswerNotificationTemplate.template_html'
        db.add_column(u'nuntium_newanswernotificationtemplate', 'template_html',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'NewAnswerNotificationTemplate.template_text'
        db.add_column(u'nuntium_newanswernotificationtemplate', 'template_text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NewAnswerNotificationTemplate.template'
        db.add_column(u'nuntium_newanswernotificationtemplate', 'template',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'NewAnswerNotificationTemplate.template_html'
        db.delete_column(u'nuntium_newanswernotificationtemplate', 'template_html')

        # Deleting field 'NewAnswerNotificationTemplate.template_text'
        db.delete_column(u'nuntium_newanswernotificationtemplate', 'template_text')
    ...
    models = {
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.newanswernotificationtemplate': {
            ...
            'template_html': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'template_text': ('django.db.models.fields.TextField', [], {'default': "''"}),
