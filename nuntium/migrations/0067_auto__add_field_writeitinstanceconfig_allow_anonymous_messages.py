...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WriteItInstanceConfig.allow_anonymous_messages'
        db.add_column(u'nuntium_writeitinstanceconfig', 'allow_anonymous_messages',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WriteItInstanceConfig.allow_anonymous_messages'
        db.delete_column(u'nuntium_writeitinstanceconfig', 'allow_anonymous_messages')
    ...
    models = {
        ...
        u'nuntium.confirmation': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 7, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.message': {
            ...
            'author_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512', 'blank': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 7, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.writeitinstanceconfig': {
            ...
            'allow_anonymous_messages': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
