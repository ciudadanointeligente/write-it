...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WriteitInstancePopitInstanceRecord'
        db.create_table(u'nuntium_writeitinstancepopitinstancerecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('writeitinstance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nuntium.WriteItInstance'])),
            ('popitapiinstance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['popit.ApiInstance'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'nuntium', ['WriteitInstancePopitInstanceRecord'])


    def backwards(self, orm):
        # Deleting model 'WriteitInstancePopitInstanceRecord'
        db.delete_table(u'nuntium_writeitinstancepopitinstancerecord')
    ...
    models = {
        ...
        u'nuntium.confirmation': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
