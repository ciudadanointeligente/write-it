...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WriteItInstance.owner'
        db.add_column(u'nuntium_writeitinstance', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WriteItInstance.owner'
        db.delete_column(u'nuntium_writeitinstance', 'owner_id')
    ...
    models = {
        ...
        u'nuntium.answer': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
