...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WriteItInstanceConfig.email_use_tls'
        db.alter_column(u'nuntium_writeitinstanceconfig', 'email_use_tls', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'WriteItInstanceConfig.email_port'
        db.alter_column(u'nuntium_writeitinstanceconfig', 'email_port', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'WriteItInstanceConfig.email_use_ssl'
        db.alter_column(u'nuntium_writeitinstanceconfig', 'email_use_ssl', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'WriteItInstanceConfig.email_use_tls'
        db.alter_column(u'nuntium_writeitinstanceconfig', 'email_use_tls', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'WriteItInstanceConfig.email_port'
        db.alter_column(u'nuntium_writeitinstanceconfig', 'email_port', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'WriteItInstanceConfig.email_use_ssl'
        db.alter_column(u'nuntium_writeitinstanceconfig', 'email_use_ssl', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
    ...
    models = {
        ...
        u'nuntium.writeitinstanceconfig': {
            ...
            'email_port': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'email_use_ssl': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'email_use_tls': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
