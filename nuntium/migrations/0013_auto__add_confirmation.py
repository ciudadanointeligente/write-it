...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'nuntium_confirmation', (
            ...
            ('key', self.gf('django.db.models.fields.CharField')(default=u'FvdDkAXkVxbVExVpPvj7AWurYDk32GrW', unique=True, max_length=64)),
            ('created', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 5, 3, 0, 0))),
    ...
    models = {
        ...
        u'nuntium.confirmation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'FvdDkAXkVxbVExVpPvj7AWurYDk32GrW'", 'unique': 'True', 'max_length': '64'}),
