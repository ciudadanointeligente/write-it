...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WriteItPerson'
        db.create_table(u'nuntium_writeitperson', (
            (u'person_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['popit.Person'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'nuntium', ['WriteItPerson'])
    ...
    def backwards(self, orm):
        # Deleting model 'WriteItPerson'
        db.delete_table(u'nuntium_writeitperson')
    ...
    models = {
        ...
        u'nuntium.answer': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.messagerecord': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'nuntium.writeitperson': {
            'Meta': {'object_name': 'WriteItPerson', '_ormbases': [u'popit.Person']},
            u'person_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['popit.Person']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'popit.apiinstance': {
