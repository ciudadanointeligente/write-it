...
managepatterns = patterns('',
    ...
    url(r'^recipients/settings/$', WriteItInstanceMaxRecipientsView.as_view(), name='writeitinstance_maxrecipients_update'),
    url(r'^message/settings/$', WriteItInstanceRateLimiterView.as_view(), name='writeitinstance_ratelimiter_update'),
