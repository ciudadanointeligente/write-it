...
class TestMessages(TestCase):
    ...
    def test_create_message(self):
        ...
        message = Message.objects.create(content = 'Content 1', subject='Subject 1', instance= self.instance, persons = [self.person1])
    ...
    def test_outboundmessage_create_without_manager(self):
        message = Message(content = 'Content 1', subject='Subject 1', instance= self.instance, persons = [self.person1])
        message.save()
...
class OutboundMessageTestCase(TestCase):
    def setUp(self):
        ...
        self.instance = Instance.objects.create(name='instance 1', api_instance= self.api_instance1)
        self.message = Message.objects.create(content = 'Content 1', subject='Subject 1', instance= self.instance, persons = [self.person1,\
            self.person2])
