...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.writeitinstance'
        db.add_column(u'contactos_contact', 'writeitinstance',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['nuntium.WriteItInstance'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.writeitinstance'
        db.delete_column(u'contactos_contact', 'writeitinstance_id')
    ...
    models = {
        ...
        u'contactos.contact': {
            ...
            'writeitinstance': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['nuntium.WriteItInstance']", 'null': 'True'})
        },
