...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RawIncomingEmail.message_id'
        db.add_column(u'mailit_rawincomingemail', 'message_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RawIncomingEmail.message_id'
        db.delete_column(u'mailit_rawincomingemail', 'message_id')
